...
public class PathGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UnityEngine.Random.InitState(System.DateTime.Now.Millisecond * 100);
    ...
    private void RemoveWall(int x, int y)
    {
        ...
        {
            _gridGenerator.FreeCells.Add(new Node((int)wallToRemove.transform.position.x, (int)wallToRemove.transform.position.y, false, false));
